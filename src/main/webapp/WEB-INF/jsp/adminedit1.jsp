...
<div class="main_contents">
    <div id="sub_content">
        <form action="adminprofile?id=${user1.getId() }" method="post" onsubmit="return validateForm()">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="name" name="name" value="${user1.getName()}" disabled="disabled">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="email" class="form-control" id="email"  name="email" value="${user1.getEmail()}" disabled="disabled">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="password" class="form-control" id="password" name="password" value="${user1.getPassword()}" disabled="disabled">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="password" class="form-control" id="confirmPassword" name="cpassword" value="${user1.getPassword()}" disabled="disabled">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <select class="form-select" aria-label="User Role" id="userRole" name="role" disabled="disabled">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <button type="button" class="btn btn-secondary col-md-2" onclick="location.href = 'adminview';">Back</button>
                </div>
            </div>
        </form>
    </div>
