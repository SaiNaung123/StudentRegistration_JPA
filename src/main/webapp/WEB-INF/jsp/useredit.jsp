...
<div class="main_contents">
    <div id="sub_content">
        <form action="userupdate?id=${user.getId() }" method="post" onsubmit="return validateForm()">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="password" class="form-control" id="confirmPassword" name="cpassword" value="${user.getPassword()}">
