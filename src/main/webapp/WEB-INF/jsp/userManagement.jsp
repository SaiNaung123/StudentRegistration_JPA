    ...
    <div id="sub_content">
        <form  method="post" class="row g-3 mt-3 ms-2">
            ...
            <div class="col-auto">
                ...
                <button type="reset" class="btn btn-secondary mb-3" style="background-color: red;" onclick="location.href = 'userview';">Reset</button>
            </div>
        </form>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-success  "
                                onclick="location.href = 'userprofile?id=${user.getId()}';">
                                See More
                            </button>
                        </td>
                        <%
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-bs-dismiss="modal" onclick="deleteUser();">Yes</button>
