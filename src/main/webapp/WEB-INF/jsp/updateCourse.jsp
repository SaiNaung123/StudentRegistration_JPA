    ...
    <div class="container">
        ...
        <div class="main_contents">
            <div id="sub_content">
                ...
                <form method="post" action="${pageContext.request.contextPath}/updateCourse" modelAttribute="course">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <button type="submit" class="btn btn-secondary col-md-2">Update</button>
                        </div>
                    </div>
                </form>
            </div>
